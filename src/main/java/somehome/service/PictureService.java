...
public class PictureService {
   ...
   */
  @Transactional
  public String addPictureForAccount(
      Account account, MultipartFile file, String description) throws IOException {
   ...
   */
  @Transactional
  private void savePictureForAccount(
      Account account, MultipartFile file, String description) throws IOException {
