...
public class SettingsService {
    ...
    public String setAccountSettings(Account account, String description, long profilePictureId) {
        ...
        if (profilePictureId == -1) {
            ...
            // else if profilePictureId is something else, make sure that account is the owner of that
    ...
    private void resetToDefaultProfilePicture(Account account) {
        if (account != null && account.getPictureAlbum() != null && account.getPictureAlbum().getPictures() != null) {
