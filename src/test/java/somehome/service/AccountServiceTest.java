...
public class AccountServiceTest {
  ...
  public void listByProfilenameWorks() {
    ...
    assertTrue(accountService.listByProfilename("profilename6")
        .get(0).getProfilename().equals("profilename6"));
  }

  private void createXnumberOfAccounts(int x) {
    for (int i = 0; i < x; i++) {
      Account account = new Account();
